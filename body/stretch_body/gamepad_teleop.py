...
class GamePadTeleop(Device):
    ...
    def using_dexwrist(self):
        return self.end_of_arm_tool == 'tool_stretch_dex_wrist' or self.end_of_arm_tool == 'tool_dw3_sg3' \
            or self.end_of_arm_tool == 'tool_dw3_no_gripper' or self.end_of_arm_tool == 'tool_dw3_custom'
