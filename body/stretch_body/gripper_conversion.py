...
https://github.com/hello-robot/stretch_ros2/blob/humble/hello_helpers/src/hello_helpers/gripper_conversion.py
"""
...
class GripperConversion():
    def __init__(self,params):
        ...
        self.open_aperture_m = self.params['open_aperture_m']   #0.09 #0.125
        self.closed_aperture_m = self.params['closed_aperture_m'] #0.0

        self.open_robotis = self.params['open_robotis'] #70.0
        self.closed_robotis = self.params['closed_robotis'] #0.0
