...
class WristPitch(DynamixelHelloXL430):
    """
    API to the Stretch wrist pitch joint
    """
    def __init__(self, chain=None, usb=None):
        DynamixelHelloXL430.__init__(self, 'wrist_pitch', chain, usb)
    ...
    def step_sentry(self, robot):
        """This sentry attempts to prevent the wrist pitch servo from overheating
        ...
        if self.hw_valid and self.robot_params['robot_sentry']['wrist_pitch_overload']:
