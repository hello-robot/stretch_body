    ...
    def pack_gains(self,s,sidx):
        with self.lock:
            ...
            if self.current_coefficients is not None:
                pack_float_t(s, sidx, self.current_coefficients[0]);sidx += 4
                pack_float_t(s, sidx, self.current_coefficients[1]);sidx += 4
                pack_float_t(s, sidx, self.current_coefficients[2]);sidx += 4
                pack_float_t(s, sidx, self.current_coefficients[3]);sidx += 4
            else:
                sidx += 16

            if self.torque_coefficients is not None:
                pack_float_t(s, sidx, self.torque_coefficients[0]);sidx += 4
                pack_float_t(s, sidx, self.torque_coefficients[1]);sidx += 4
                pack_float_t(s, sidx, self.torque_coefficients[2]);sidx += 4
                pack_float_t(s, sidx, self.torque_coefficients[3]);sidx += 4
            else:
                sidx += 16
