...
class WristRoll(DynamixelHelloXL430):
    """
    API to the Stretch wrist roll joint
    """
    def __init__(self, chain=None, usb=None):
        DynamixelHelloXL430.__init__(self, 'wrist_roll', chain, usb)
    ...
    def step_sentry(self, robot):
        """This sentry attempts to prevent the wrist roll servo from overheating
        ...
        if self.hw_valid and self.robot_params['robot_sentry']['wrist_roll_overload']:
